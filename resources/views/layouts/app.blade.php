...
{{--    <title>{{  \App\Models\Tenant::find(\Illuminate\Support\Facades\Auth::user()->tenant_id)->name }}</title>--}}
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{ URL::asset('css/plugins/skins/all.css') }}">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" id="logout-btn" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                {{--<img src="{{ asset('Logo.bmp') }}" class="user-image" alt="User Image"/>--}}
...
{{--                                    <img src="{{ asset('Logo.bmp') }}" class="img-circle" alt="User Image"/>--}}
                                    <img src="{{ asset('images.ico') }}" class="user-image" alt="User Image"/>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{!! url('/reset-pass') !!}" class="btn btn-default btn-flat">Update password</a>
                                    </div>
        ...
        <footer class="main-footer no-print" style="max-height: 100px;text-align: center">
            <strong>Powered by <a href="#">OpenPath Solutions</a>.</strong>
        </footer>
...
//            $("#table1").DataTable();
            $("body").find('input[type="checkbox"].i-check,input[type="radio"].i-check').iCheck({
            ...
            $('input[type="radio"].i-check-line').each(function(){
                var self = $(this),
                    label = self.next(),
