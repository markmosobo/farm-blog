...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('customer_messages.table')
            </div>
        </div>
...
@section('modals')
    <div class="modal fade" id="create-modal" role="dialog">
            {!! Form::open(['route' => 'customerMessages.store']) !!}
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            @include('customer_messages.fields')
                        </div>
                    </div>
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
           ...
           <div class="modal-dialog">
               <div class="modal-content">
                   ...
                   <div class="modal-footer">
                       <input type="hidden" id="editDetails" value="{{ url("/customerMessages") }}">
                       <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Delete Customer Message</h4>
                        </div>
                        <div class="modal-body">
                            <p>Are you sure you want to delete this Customer Message?</p>
                        </div>
                        <div class="modal-footer">
