@extends('layouts.app')
 @section("pageTitle",'Customer Accounts')
 @section("pageSubtitle",'create, edit, delete CustomerAccounts')
  @section("breadcrumbs")
         <li>Home</li> <li>CustomerAccounts</li>
         @endsection
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('customer_accounts.table')
            </div>
        </div>
...
@section('modals')
    <div class="modal fade" id="create-modal" role="dialog">
            {!! Form::open(['route' => 'customerAccounts.store']) !!}
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            @include('customer_accounts.fields')
                        </div>
                    </div>
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
           ...
           <div class="modal-dialog">
               <div class="modal-content">
                   ...
                   <div class="modal-footer">
                       <input type="hidden" id="editDetails" value="{{ url("/customerAccounts") }}">
                       <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                       <button type="submit" class="btn btn-primary">Save</button>
                   </div>
               </div>
